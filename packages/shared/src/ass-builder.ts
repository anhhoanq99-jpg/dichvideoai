 ...
 * Alignment fixed at 2 (bottom-center) — position tweaks via marginV.
 */
export function buildAss(
  ...
  const header = [
    ...
    `Style: Default,${style.font},${style.size},${primary},${primary},${outline},${back},0,0,0,0,100,100,0,0,${style.borderStyle},${style.borderStyle === 3 ? 4 : 2},0,2,60,60,${style.marginV},1`,
    "",
    "[Events]",
