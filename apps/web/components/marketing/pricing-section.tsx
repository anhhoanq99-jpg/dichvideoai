...
const T = {
  vi: {
    ...
    serviceRows: [
      ...
      { label: "Dịch nhanh — máy dịch", price: `${CREDIT_PRICING.translateMachinePerLine} xu/dòng` },
  ...
  en: {
    ...
    serviceRows: [
      ...
      { label: "Fast machine translation", price: `${CREDIT_PRICING.translateMachinePerLine} credits/line` },
