...
const T = {
  vi: {
    ...
    p: "AI tự động tối ưu giúp tiết kiệm thời gian làm video Ads Facebook, TikTok, Review phim, Anime, Affiliate,…",
  ...
  en: {
    ...
    p: "AI optimizes it for you — save hours making Facebook & TikTok ads, movie reviews, anime, affiliate videos…",
